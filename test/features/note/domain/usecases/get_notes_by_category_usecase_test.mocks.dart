...
// in speaking_notes/test/features/note/domain/usecases/get_notes_by_category_usecase_test.dart.
...
import 'package:speaking_notes/features/note/domain/models/note.dart' as _i4;
...
class MockNoteRepository extends _i1.Mock implements _i2.NoteRepository {
  ...
  @override
  _i3.Future<List<_i4.Note>> getNotesByCategory(String? categoryId) =>
      (super.noSuchMethod(
            Invocation.method(#getNotesByCategory, [categoryId]),
            returnValue: _i3.Future<List<_i4.Note>>.value(<_i4.Note>[]),
          )
          as _i3.Future<List<_i4.Note>>);
